...
const interestOptions = [
  "Beach", "Hiking", "Photography", "Food Tours", "Culture", "Nightlife", "Museums", "Adventure", "Wellness", "Shopping", "History", "Architecture", "Nature", "Wildlife", "Sports",
];
...
export default function EditTravelPlanPage() {
    ...
    const fetchPlan = async () => {
      try {
        const res = await fetch(
          `${process.env.NEXT_PUBLIC_BASE_URL}/api/v1/travel/${params.id}`,
          { credentials: "include" }
        );
        ...
        toast.error(err.message || "Failed to load travel plan");
  ...
  const onSubmit = async (data: TravelPlanFormValues) => {
    ...
    try {
      ...
      if (!res.ok) throw new Error(result.message || "Failed to update travel plan");
      ...
      <div className="container mx-auto px-4 py-12">
        <Card>
          <CardContent className="py-12 text-center">
            <p className="text-muted-foreground mb-4">Please log in to edit a travel plan</p>
            <Button asChild>
    ...
    <div className="min-h-screen bg-muted/30">
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">Update your travel plan details</p>
        </div>
        <form onSubmit={handleSubmit(onSubmit)}>
          <Card>
            <CardHeader>
              <CardTitle>Trip Details</CardTitle>
              <CardDescription>Update your travel plan</CardDescription>
            </CardHeader>
